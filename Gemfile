...
gem 'rails', '>= 6.1.7.9', RAILS_VERSION
gem 'jquery-rails'
gem 'bundler',                     '>= 1.0.0'
gem 'env'
gem 'json', '~> 1.7'
...
gem 'actionpack', '>= 6.1.7.9', RAILS_VERSION, :require => 'action_pack'
gem 'actionmailer', '>= 6.1.7.9', RAILS_VERSION, :require => 'action_mailer'
gem 'railties', '>= 6.1.7.9', RAILS_VERSION, :require => 'rails'
