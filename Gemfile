...
# Jruby
gem 'jruby-openssl', '>= 0.9.5', :platforms => :jruby
...
gem 'actionpack', '>= 7.1.0', RAILS_VERSION, :require => 'action_pack'
gem 'actionmailer', '>= 7.1.0', RAILS_VERSION, :require => 'action_mailer'
gem 'railties', '>= 7.1.0', RAILS_VERSION, :require => 'rails'
