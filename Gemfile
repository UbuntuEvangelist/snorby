...
gem 'rails', '>= 6.1.7.3', RAILS_VERSION
...
gem 'activesupport', '>= 6.1.7.3', RAILS_VERSION, :require => 'active_support'
gem 'actionpack', '>= 6.1.7.3', RAILS_VERSION, :require => 'action_pack'
gem 'actionmailer', '>= 6.1.7.3', RAILS_VERSION, :require => 'action_mailer'
gem 'railties', '>= 6.1.7.3', RAILS_VERSION, :require => 'rails'
gem 'dm-core',                     DM_VERSION
gem 'dm-rails', '>= 1.2.1', DM_VERSION
gem 'dm-do-adapter',               DM_VERSION
gem 'dm-active_model', '>= 1.2.1', DM_VERSION
gem 'dm-mysql-adapter',            DM_VERSION

gem 'dm-pager',                    '~> 1.1.0'
gem "dm-ar-finders",               DM_VERSION
gem 'dm-migrations',               DM_VERSION
gem 'dm-types', '>= 1.2.2', DM_VERSION
...
gem 'dm-serializer', '>= 1.2.2', DM_VERSION
