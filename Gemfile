...
gem 'actionpack', '>= 5.0.0', RAILS_VERSION, :require => 'action_pack'
gem 'actionmailer', '>= 5.0.0', RAILS_VERSION, :require => 'action_mailer'
gem 'railties', '>= 5.0.0', RAILS_VERSION, :require => 'rails'
