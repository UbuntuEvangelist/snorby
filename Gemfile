...
gem 'rails', '>= 5.2.6.2', RAILS_VERSION
...
gem 'actionpack', '>= 5.2.6.2', RAILS_VERSION, :require => 'action_pack'
gem 'actionmailer', '>= 5.2.6.2', RAILS_VERSION, :require => 'action_mailer'
gem 'railties', '>= 5.2.6.2', RAILS_VERSION, :require => 'rails'
