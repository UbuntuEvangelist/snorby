...
gem 'rails', '>= 6.0.3.5', RAILS_VERSION
...
gem 'actionpack', '>= 6.0.3.5', RAILS_VERSION, :require => 'action_pack'
gem 'actionmailer', '>= 6.0.3.5', RAILS_VERSION, :require => 'action_mailer'
gem 'railties', '>= 6.0.3.5', RAILS_VERSION, :require => 'rails'
